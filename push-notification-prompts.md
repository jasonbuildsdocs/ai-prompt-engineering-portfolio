...
### Example Usage
```
You are writing a push notification for Strawberry Fields promoting flash sale.

Offer Details:
- Promotion: 30% off all pre-rolls
- Value: 30% discount
- Urgency: Ends in 6 hours
- Target Segment: Customers who purchased pre-rolls in last 30 days
...
- CTA Implication: Tap to shop pre-rolls
...
```
You are writing a behavior-triggered push notification for Strawberry Fields.

Trigger Event:
- Action: ABANDONED_CART
- User Data: Left 2 items in cart (Sour Diesel pre-roll, mango gummies)
- Timing: 2 hours after cart abandonment

Personalization Elements:
- Product/Category: Pre-rolls and edibles
