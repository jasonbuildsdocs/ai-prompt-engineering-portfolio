...
### Example Usage
```
You are writing a re-engagement email for Strawberry Fields (cannabis retail) targeting customers who haven't made a purchase in 90+ days.

Customer Context:
- Last Purchase/Interaction: 4 months ago
- Previous Purchase Category: Pre-rolls and edibles
...
Message Strategy:
SHARE_UPDATES - mention new product arrivals and improved rewards program
